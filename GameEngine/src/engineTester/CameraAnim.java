...
import utils.DisplayManagerAnim;
 ...
 *
 */
public class CameraAnim implements ICamera {
	...
	private void calculatePitch() {
		...
		pitch.update(DisplayManagerAnim.getFrameTime());
	}
	...
	private void calculateAngleAroundPlayer() {
		...
		angleAroundPlayer.update(DisplayManagerAnim.getFrameTime());
	}
